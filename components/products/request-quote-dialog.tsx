    ...
    >
      <DialogTrigger
        render={
          <Button
            size="xl"
            className="bg-brand hover:bg-brand/90 text-brand-foreground hover:opacity-90"
          />
        }
      >
        Request quote
      ...
      <DialogContent className="sm:max-w-125">
        <DialogHeader>
          ...
          <DialogDescription>
            Tell us where to send pricing and product information for{" "}
            {productName}.
          </DialogDescription>
        </DialogHeader>
        {status === "success" ? (
          ...
          <form onSubmit={submit} className="flex flex-col gap-5">
            ...
            <div className="flex flex-col gap-2">
              ...
              <Textarea
                ...
                placeholder="Project details, quantities, or delivery requirements"
                rows={4}
              />
            </div>
            {status === "error" ? (
